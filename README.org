...
In order to use the scripts you should install python-iptables from [[https://github.com/domq/epfl.mybackup/blob/master/python-iptables-python3.zip?raw=true][here]]:
: yum install python3-devel -y
: unzip  python-iptables-python3.zip
...
You should also install pika for python3.
